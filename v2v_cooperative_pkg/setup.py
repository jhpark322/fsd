...
setup(
    ...
    entry_points={
        'console_scripts': [
            ...
            'reverse_path_planner_node = v2v_cooperative_pkg.reverse_path_planner_node:main',
            'chassis_control_node   = v2v_cooperative_pkg.chassis_control_node:main',
            'safety_supervisor_node = v2v_cooperative_pkg.safety_supervisor_node:main',
